...
_pasrt4.run(_parg4.rec(dog.age += _parg4.tap(1, 30), 27), _parg5.rec(three, 33));
_pasrt5.run(_parg6.rec([x] = _parg6.tap([_parg6.tap(3, 14)], 13), 11));
_pasrt6.run(_parg7.rec([x] = _parg7.tap([_parg7.tap(foo, 14)], 13), 11));
