...
_pasrt3.run(_parg3.rec(_parg3.tap(foo(), 10) ? _parg3.tap(_parg3.tap(bar, 15).baz, 19) : _parg3.tap(typeof goo, 26), 13));
_pasrt4.run(_parg4.rec(_parg4.tap(foo, 14) ? _parg4.tap(bar, 20) : _parg4.tap(baz, 26), 18), _parg5.rec(_parg5.tap(falsy, 33) ? _parg5.tap(truthy, 41) : _parg5.tap(_parg5.tap(truthy, 50) ? _parg5.tap(anotherFalsy, 59) : _parg5.tap(truthy, 74), 57), 39));
