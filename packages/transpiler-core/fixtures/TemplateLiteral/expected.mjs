...
_pasrt1.run(_parg1.rec(`Hello`, 7));
_pasrt2.run(_parg2.rec(`Hello, ${_parg2.tap(nickname, 17)}`, 7));
_pasrt3.run(_parg3.rec(`Hello, ${_parg3.tap(_parg3.tap(user, 17).nickname, 22)}`, 7));
