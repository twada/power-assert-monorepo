...
_pasrt4.run(_parg1.rec(_parg1.tap(seven, 7, 7, 12, {
  hint: "left"
}) === _parg1.tap(((v, i) => v + i)(_parg1.tap(four, 35, 35, 39), _parg1.tap(five, 41, 41, 45)), 34, 17, 46, {
  hint: "right"
}), 13, 7, 46));
test('test name', () => _pasrt5.run(_parg2.rec(_parg2.tap(_parg2.tap(user, 7, 7, 11).name, 12, 7, 16, {
  hint: "left"
}) === _parg2.tap('Bob', 21, 21, 26, {
  hint: "right"
}), 17, 7, 26)));
test('promise', () => {
  ...
  return Promise.resolve().then(() => _pasrt6.run(_parg3.rec(_parg3.tap(true, 7, 7, 11, {
    hint: "left"
  }) === _parg3.tap(false, 16, 16, 21, {
    hint: "right"
  }), 12, 7, 21)));
});
