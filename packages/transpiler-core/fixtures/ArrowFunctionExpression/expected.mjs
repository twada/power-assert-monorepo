...
_pasrt4.run(_parg1.rec(_parg1.tap(seven, "arguments/0/left", 7) === _parg1.tap(((v, i) => v + i)(_parg1.tap(four, "arguments/0/right/arguments/0", 35), _parg1.tap(five, "arguments/0/right/arguments/1", 41)), "arguments/0/right", 34), "arguments/0", 13));
