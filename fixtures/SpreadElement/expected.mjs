...
_pasrt1.run(_parg1.rec(hello(..._parg1.tap(names, "arguments/0/arguments/0/argument", 16)), "arguments/0", 12));
...
_pasrt3.run(_parg3.rec(f(_parg3.tap(head, "arguments/0/arguments/0", 9), ..._parg3.tap(iter(), "arguments/0/arguments/1/argument", 22), ..._parg3.tap([_parg3.tap(foo, "arguments/0/arguments/2/argument/elements/0", 30), _parg3.tap(bar, "arguments/0/arguments/2/argument/elements/1", 35)], "arguments/0/arguments/2/argument", 29)), "arguments/0", 8));
assert(...iter());
assert(...[foo, bar]);
